...
"""Generate batched grad tests for all minijax primitives.

Run from the repository root:
    python tests/milestone1/base/unit/grad/generate_primitive_grad_tests.py
"""
...
from minijax.grad import _forward, _backwards  # noqa: E402
